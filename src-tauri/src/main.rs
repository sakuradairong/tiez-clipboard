...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            services::clipboard_ops::paste_latest_plain,
            ...
            app::commands::set_plain_paste_hotkey,
            app::commands::set_search_hotkey,
            app::commands::set_relay_send_hotkey,
            ...
            services::cloud_sync::stop_cloud_sync_client,
            app::commands::request_cloud_sync,
            app::commands::cloud_sync_now,
            app::commands::relay_send_clipboard,
            app::commands::relay_fetch_to_clipboard,
            app::commands::relay_shared_key_status,
            app::commands::relay_set_shared_key,
            app::commands::relay_generate_shared_key,
            app::commands::relay_clear_shared_key,
            ...
            services::image_analysis::analyze_image_entry,
            services::image_analysis::get_image_analysis,
            services::backup::create_backup,
            services::backup::inspect_backup,
            services::backup::schedule_backup_restore,
