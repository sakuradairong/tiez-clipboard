...
pub fn seed_defaults(conn: &Connection) -> Result<()> {
    ...
    let _ = conn.execute(
        "INSERT OR IGNORE INTO settings (key, value) VALUES ('app.relay_send_hotkey', '')",
        [],
    );
    let _ = conn.execute(
        "INSERT OR IGNORE INTO settings (key, value) VALUES ('app.relay_fetch_hotkey', '')",
        [],
    );
    let _ = conn.execute(
    ...
    let _ = conn.execute(
        "INSERT OR IGNORE INTO settings (key, value) VALUES ('app.quick_paste_when_edge_hidden', 'true')",
        [],
    );
    let _ = conn.execute(
